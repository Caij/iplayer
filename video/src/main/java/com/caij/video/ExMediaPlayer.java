...
public interface ExMediaPlayer {
    ...
    void setNextMediaPlayer(ExMediaPlayer nextMediaPlayer) throws UnsupportedOperationException;
    ...
    interface OnPreparedListener {
        void onPrepared(ExMediaPlayer mp);
    }

    interface OnCompletionListener {
        void onCompletion(ExMediaPlayer mp);
    }

    interface OnBufferingUpdateListener {
        void onBufferingUpdate(ExMediaPlayer mp, int percent);
    }

    interface OnSeekCompleteListener {
        void onSeekComplete(ExMediaPlayer mp);
    }

    interface OnVideoSizeChangedListener {
        void onVideoSizeChanged(ExMediaPlayer mp, int width, int height);
    }

    interface OnErrorListener {
        boolean onError(ExMediaPlayer mp, int what, int extra);
    }

    interface OnInfoListener {
        boolean onInfo(ExMediaPlayer mp, int what, int extra);
    }
}
